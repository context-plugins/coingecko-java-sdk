 ...
 */
@JsonDeserialize(using = ExchangeVolumeChart.ExchangeVolumeChartDeserializer.class)
public abstract class ExchangeVolumeChart {
     ...
     */
    public static ExchangeVolumeChart fromPrecision(double precision) {
     ...
     */
    public static ExchangeVolumeChart fromString(String string) {
    ...
    private static class PrecisionCase extends ExchangeVolumeChart {
    ...
    private static class StringCase extends ExchangeVolumeChart {
    ...
    /**
     * This is a custom deserializer class for ExchangeVolumeChart.
     */
    protected static class ExchangeVolumeChartDeserializer
            extends JsonDeserializer<ExchangeVolumeChart> {

        @Override
        public ExchangeVolumeChart deserialize(JsonParser jp, DeserializationContext ctxt)
