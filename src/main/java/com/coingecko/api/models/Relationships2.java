...
public class Relationships2 {
     ...
     * @param  pool  Pool2 value for pool.
     */
    public Relationships2(
            Pool2 pool) {
        this.pool = pool;
    ...
    /**
     * Getter for Pool.
     * @return Returns the Pool2
     */
    @JsonGetter("pool")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Pool2 getPool() {
        return pool;
    }

    /**
     * Setter for Pool.
     * @param pool Value for Pool2
     */
    @JsonSetter("pool")
    public void setPool(Pool2 pool) {
        this.pool = pool;
    }
    ...
    public String toString() {
        return "Relationships2 [" + "pool=" + pool + ", additionalProperties="
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder pool(Pool2 pool) {
            this.pool = pool;
            return this;
        }
