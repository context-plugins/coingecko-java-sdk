...
public class Included3 {
     ...
     * @param  attributes  Attributes8 value for attributes.
     */
    public Included3(
            String id,
            String type,
     ...
     * @return Returns the Attributes8
     */
     ...
     * @param attributes Value for Attributes8
     */
    ...
    public String toString() {
        return "Included3 [" + "id=" + id + ", type=" + type + ", attributes=" + attributes
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder attributes(Attributes8 attributes) {
            this.attributes = attributes;
            return this;
        }
        ...
        public Included3 build() {
            Included3 model =
                    new Included3(id, type, attributes);
