...
|  --- | --- | --- | --- | --- | --- |
| `Data` | [`PoolAddressItem`](../../doc/models/pool-address-item.md) | Required | - | PoolAddressItem getData() | setData(PoolAddressItem data) |
...
PoolAddressData poolAddressData = new PoolAddressData.Builder(
