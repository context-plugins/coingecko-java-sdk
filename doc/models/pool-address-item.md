...
| `Relationships` | [`Relationships`](../../doc/models/relationships.md) | Required | Related resources | Relationships getRelationships() | setRelationships(Relationships relationships) |
...
PoolAddressItem poolAddressItem = new PoolAddressItem.Builder(
    "id2",
    "type8",
