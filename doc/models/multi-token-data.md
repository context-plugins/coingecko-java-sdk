...
|  --- | --- | --- | --- | --- | --- |
| `Data` | [`List<TokenItem>`](../../doc/models/token-item.md) | Required | - | List<TokenItem> getData() | setData(List<TokenItem> data) |
| `Included` | [`List<Included4>`](../../doc/models/included-4.md) | Optional | Included top pool data, present when include=top_pools is specified | List<Included4> getIncluded() | setIncluded(List<Included4> included) |
...
MultiTokenData multiTokenData = new MultiTokenData.Builder(
    Arrays.asList(
